...
public:
  ...
  /** @brief add Series to TVSeriesAPP */
  void addTitleBasic(const Series& title);

  /** @brief add Episode to TVSeriesAPP  */
  void addTitleEpisode(const Episode& episode);

  /** @brief add Person to TVSeriesAPP */
  void addTitlePrincipals(const Person& principal);
